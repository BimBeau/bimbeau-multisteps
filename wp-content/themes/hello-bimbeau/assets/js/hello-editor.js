...
class ControlsHook extends $e.modules.hookUI.After {
  ...
  getId() {
    ...
    return 'hello-bimbeau-editor-controls-handler';
  }

  /**
   * Get Hello BimBeau Theme Controls
   *
   ...
   *   {
   *      hello_bimbeau_show_logo: '.site-header .site-header-logo',
   *      hello_bimbeau_show_menu: '.site-header .site-header-menu',
   *   }
   */
