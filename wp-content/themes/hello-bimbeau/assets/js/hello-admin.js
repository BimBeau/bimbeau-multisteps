...
const SettingsPage = () => {
  ...
  const settingsPrefix = 'hello_bimbeau_settings';
  ...
  const saveSettings = () => {
    ...
    settings.save();
    (0, _data.dispatch)('core/notices').createNotice('success', (0, _i18n.__)('Settings Saved', 'hello-bimbeau'), {
      type: 'snackbar',
      isDismissible: true
    });
  };
  ...
  return /*#__PURE__*/React.createElement(_react.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "hello_bimbeau__header"
  }, /*#__PURE__*/React.createElement("div", {
    className: "hello_bimbeau__container"
  }, /*#__PURE__*/React.createElement("div", {
    className: "hello_bimbeau__title"
  }, /*#__PURE__*/React.createElement("h1", null, (0, _i18n.__)('Hello Theme Settings', 'hello-bimbeau'))))), /*#__PURE__*/React.createElement("div", {
    className: "hello_bimbeau__main"
  ...
  }, (0, _i18n.__)('Save Settings', 'hello-bimbeau')))), /*#__PURE__*/React.createElement("div", {
    className: "hello_bimbeau__notices"
...
const SettingsPanel = ({
  ...
  return /*#__PURE__*/React.createElement(_components.PanelBody, {
    title: (0, _i18n.__)('Hello Theme Settings', 'hello-bimbeau')
  }, /*#__PURE__*/React.createElement(_components.Notice, {
    status: "warning",
    isDismissible: "false"
  }, /*#__PURE__*/React.createElement(_components.Dashicon, {
    icon: "flag"
  }), (0, _i18n.__)('Be cautious, disabling some of the following options may break your website.', 'hello-bimbeau')), /*#__PURE__*/React.createElement(_components.ToggleControl, {
    label: (0, _i18n.__)('Disable description meta tag', 'hello-bimbeau'),
    help: (0, _i18n.__)('Remove the description meta tag in singular content pages that contain an excerpt.', 'hello-bimbeau'),
    ...
    label: (0, _i18n.__)('Disable skip link', 'hello-bimbeau'),
    help: (0, _i18n.__)('Remove the "Skip to content" link used by screen-readers and users navigating with a keyboard.', 'hello-bimbeau'),
    ...
    label: (0, _i18n.__)('Disable page title', 'hello-bimbeau'),
    help: (0, _i18n.__)('Remove the section above the content that contains the main heading of the page.', 'hello-bimbeau'),
    ...
    label: (0, _i18n.__)('Unregister Hello style.css', 'hello-bimbeau'),
    help: (0, _i18n.__)("Disable Hello theme's style.css file which contains CSS reset rules for unified cross-browser view.", 'hello-bimbeau'),
    checked: !!settingsData[SETTINGS.HELLO_STYLE] || false,
    onChange: value => updateSettings(SETTINGS.HELLO_STYLE, value)
  }), /*#__PURE__*/React.createElement("code", {
    className: "code-example"
  }, " <link rel=\"stylesheet\" href=\"", prefix, "/wp-content/themes/hello-bimbeau/style.min.css\" /> "), /*#__PURE__*/React.createElement(_components.ToggleControl, {
    label: (0, _i18n.__)('Unregister Hello theme.css', 'hello-bimbeau'),
    help: (0, _i18n.__)("Disable Hello theme's theme.css file which contains CSS rules that style WordPress elements.", 'hello-bimbeau'),
    checked: !!settingsData[SETTINGS.HELLO_THEME] || false,
    onChange: value => updateSettings(SETTINGS.HELLO_THEME, value)
  }), /*#__PURE__*/React.createElement("code", {
    className: "code-example"
  }, " <link rel=\"stylesheet\" href=\"", prefix, "/wp-content/themes/hello-bimbeau/theme.min.css\" /> "));
};
...
document.addEventListener('DOMContentLoaded', () => {
  const rootElement = document.getElementById('hello-bimbeau-settings');
  if (rootElement) {
